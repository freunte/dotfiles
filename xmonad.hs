...
myStartupHook = do
        ...
        spawnOnce "xrandr --output HDMI1 --auto --left-of LVDS1 &"
        spawnOnce "picom -f &"
        spawnOnce "feh --bg-fill --randomize /home/rene/Images/*"
        spawnOnce "nm-applet &"
...
myPP = xmobarPP 
    ...
    , ppCurrent         = wrap " " "" . xmobarBorder "Top" "#1793d1" 2
    , ppHidden          = white . wrap " " ""
    , ppVisible         = lowWhite . wrap " " ""
