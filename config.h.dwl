...
static const float fullscreen_bg[]         = {0.1, 0.1, 0.1, 0.75}; /* You can also use glsl colors */
...
static const MonitorRule monrules[] = {
	...
	*/
	...
	{ "HDMI-1",   0.5,  1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },    
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_b,           spawn,          {.v = browser } },
        { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_F,           spawn,          {.v = fmngr } },
	...
	TAGKEYS(          XKB_KEY_6, XKB_KEY_slash,                      5),
